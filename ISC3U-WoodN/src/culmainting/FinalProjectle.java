...
public class FinalProjectle {
	static Console c = new Console (50, 150);           // The output console
	public static void main(String[] args) {
		...
		String guess = guess1.toUpperCase();
		//Tracks Guess Word
		...
		yellower(currentChar, guessChar);

		//Correcting Check


		if ((currentWord).equalsIgnoreCase(guess)) { 				//Word is Correct
	...
	public static void yellower(char[] currentChar, char[] guessChar) {
		
		int[]squareY= {50, 150, 250, 350, 450};
		boolean [] isYellow; 
		...
		for(int i = 0; i < 5; i++) {
			...
			for(int g = 0, q = 0; g < 5; q++, g++) {
				if ((currentChar[i]) == (guessChar[g])) {
					System.out.println("True");
					isYellow[g] = true;
					c.setColor(Color.yellow);
					c.fillRect(squareY[i], 100, 90, 90);
				} else {
	...
	public static void greener(char[] currentChar, char[] guessChar) {
	int[]squareY= {50, 150, 250, 350, 450};
	boolean [] isGreen; 
