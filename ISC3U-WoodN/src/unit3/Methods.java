package unit3;
/**
Description: Learning about how mehtods work
...
public class Methods {
    ...
    Using Static Methods
		...
		System.out.println("School is about to go on break");
    ...
    You as the user don't know how it works, but because someone has made it, you can simply use it again and again.
		...
		/**
		The variable myNum is created and given the value of 30
		The variable myNum is used in the method doubleNumber and applied as the new value of myNum
